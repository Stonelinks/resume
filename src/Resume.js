            ...
            >
              <div>
                ...
                <p>
                  ...
                  compare layers. Also built many enterprise-focused features
                  like user management, permissions and SSO / authentication.
                </p>

                <p>
                  <b>Mobile:</b> Helped bootstrap Airware's first mobile app for
                  drone operators to fly, capture and upload drone data to the
                  cloud. Leveraged team skills and code reuse with a
                ...
                <p>
                  <b>Leadership:</b> Engaged in engineering leadership and
                  product lifecycle. Helped define requirements, led feature
                  development and ran meetings. Architected and completed
                  several large scale refactors and migrations, including a
                  Backbone to react migration as well as a product merger after
                  acquiring a French company. Served as a manager on an
                  as-needed basis; helped plan quarters and hired engineers.
                </p>
              </div>
            </Section>
            <Section
            ...
            >
              <div>
                <p>
                  ...
                  robotics startup straight out of college. Created web
                  interface for an industrial arm planning system used by Canon,
                  Honda and several Japanese system integrators.
                </p>
                <ul>
                  <li>
              ...
              <div>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    coordinated work with external component vendors. Saved
                    costs by developing efficient shutter controllers using
                    Arduinos.
                  </li>
                </ul>
              </div>
            ...
            >
              <div>
                <ul>
                  ...
                  <li>
                    Implemented forehead screen UI to display internal robot
                    state and answer calls made to the robot.
                  </li>
                </ul>
              </div>
            </Section>
              ...
              <div>
                <p>
                  <b>
                    ...
                    <ExternalLink
                      href={"http://stonelinks.org/projects/boeing"}
                    >
                      <FaExternalLinkAlt style={styles.iconStyle} />
                    </ExternalLink>:{" "}
                  </b>
                  Simulated an intra-wing robot to operate inside an aircraft
                  and conduct inspection and assembly tasks.
                </p>
                <p>
                  <b>
                    {"DaBuzz Market Sentiment Analyzer"}
                    <ExternalLink
                      href={"http://stonelinks.org/projects/dabuzz"}
                    >
                      <FaExternalLinkAlt style={styles.iconStyle} />
                    </ExternalLink>:{" "}
                  </b>
            ...
            <Section name={"Software Development"}>
              <div>
                <p>
                  ...
                  javascript tooling for build and unit testing. Familiarity
                  with Swift / iOS, PHP, C++.
                </p>
                <p>
